        ...
        <div id="capa1" class="capaContenido">
            ...
            <form role="form">
                <div class="row">
                    ...
                    <div class="col-xs-1">
                        <div id="ico_fav" ng-class="filtro.destacado ? 'destacado' : ((filtro.destacado == undefined)?'normal semi-transparente':'normal')" ng-click="setFiltroDestacado()" title="Filtrar contactos destacados"></div>
                        <div id="ico_camera" ng-click="setFiltroFotografo()">
                            <i class="fa fa-camera" ng-class="filtro.fotografo ? '' : ((filtro.fotografo == undefined)?'casi-transparente':'semi-transparente')"></i>
                        </div>
                    </div>
                </div>	
                <div class="row">
