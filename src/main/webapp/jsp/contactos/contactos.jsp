        ...
        <div id="capa1" class="capaContenido">
            <form role="form" name="buscaContactosForm">
                <div class="row">
                    ...
                    <div class="col-xs-1">
                        <div id="ico_fav" ng-class="contacto.destacado ? 'destacado' : ((contacto.destacado == undefined)?'normal semi-transparente':'normal')" ng-click="setFiltroDestacado()" title="Filtrar contactos destacados"></div>
                        <div id="ico_camera" ng-click="setFiltroFotografo(contacto)">
                            <i class="fa fa-camera" ng-class="contacto.fotografo ? '' : ((contacto.fotografo == undefined)?'casi-transparente':'semi-transparente')"></i>
                        </div>
                    </div>
                </div>
                ...
                <table class="table">
                    ...
                    <tbody>
                            ...
                            <td colspan="6">
                                <form role="form" name="formAltaContacto" novalidate="novalidate">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-8">
                                            <input type="checkbox" ng-model="contactoEdicion.fotografo"
                                                   ng-true-value="1"
                                                   ng-false-value="0">
                                        </div>
                                    </div>
                        ...
                        <tr ng-repeat="contact in contactos">
                            <td>
                                <div id="ico_fav" ng-class="contact.destacado ? 'destacado' : 'normal'" ng-click="setDestacado(contact)"></div>
                                <div id="ico_camera" ng-click="setFotografo(contact)">
                                    <i class="fa fa-camera" ng-class="contact.fotografo ? '' : 'semi-transparente'"></i>
                                </div>
                            </td>
